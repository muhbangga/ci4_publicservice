  ...
  <div class=" container">
    <div class="row">
      ...
      <div class="col-lg-5" data-aos="fade-up">
        <h2 class="faq-title">Kirim Permohonan</h2>
      ...
      <div class="col-lg-7" data-aos="fade-up" data-aos-delay="300">
        <div class="faq-container">
          <div class="card card-md">
            <div class="card-body">
              <form action="<?= base_url('beranda/submit/') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <label>Nama Lengkap</label><small style="color: grey;">*</small>
                <div class="form-group">
                  <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control" required value="<?= old('nama_lengkap') ?>">
                </div>
                <label>No. Handphone </label><small style="color: grey;">*</small>
                <div class=" form-group">
                  <input type="text" name="no_handphone" id="no_handphone" class="form-control" required value="<?= old('no_hp') ?>">
                </div>
                <label>Email </label><small style="color: grey;">*</small>
                <div class="form-group">
                  <input type="email" name="email" id="email" class="form-control" required value="<?= old('email') ?>">
                </div>
                <div class="form-group">
                  <label for="email_konfirmasi">Konfirmasi Email:</label>
                  <input type="email" name="email_konfirmasi" id="email_konfirmasi" class="form-control" required>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Jenis Kelamin</label><small style="color: grey;">*</small>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Agama</label><small style="color: grey;">*</small>
                ...
                <div class="form-group">
                  <label>Pemohon</label><small style="color: grey;">*</small>
                ...
                <div class="form-group">
                  <label>Layanan</label> <small style="color: grey;">*</small>
                ...
                <div class="form-group">
                  <label>Unggah Berkas</label> <small style="color: grey;"><i>(Jadikan satu file berformat pdf, sesuaikan dengan persyaratan)</i></small>
                  <input class="form-control form-control-sm" id="lampiran" type="file" accept=".pdf" name="lampiran" requied>
                </div>
                <br>
                <p style="color: grey;"><small>*)<i>Wajib diisi</i></small></p>
                <div class="row">
                  <div class="col-sm-8">
                    <p style="color: red;"><i class="bi bi-exclamation-triangle-fill"></i> <i><small>Pastikan data yang anda isikan sudah benar</small></i></p>
                  </div>
