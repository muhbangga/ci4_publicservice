...
<div class="page-heading">
  ...
  <section class="section">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <table class="table" id="table1">
          ...
          <tbody>
            <?php $no = 1;
            foreach ($pemohon as $key => $row) : ?>
              <tr>
                <td class="text-center"><?= $no++ ?></td>
                <td><?= $row['asal_pemohon'] ?></td>
    ...
    <!-- Add Modal -->
    <?= $this->include('backend/data_pemohon/form/add'); ?>

    <!-- End Edit Modal -->
    <?= $this->include('backend/data_pemohon/form/edit'); ?>

    <!-- Delete Modal -->
    <?= $this->include('backend/data_pemohon/form/delete'); ?>
