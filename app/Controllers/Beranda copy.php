...
class Beranda extends BaseController
{
    ...
    public function submit()
    {
        ...
        $rules = [
            ...
            'no_handphone' => [
                ...
                'errors' => [
                    ...
                    'max_length' => 'Nomor HP maksimal 12 karakter.'
                ]
            ],
            'email' => [
                'rules' => 'required',
            ...
            'email_konfirmasi' => [
                'rules' => 'required|matches[email]', // Validasi harus sama dengan field 'email'
                'errors' => [
                    'required' => 'Form konfirmasi email tidak boleh kosong',
                    'matches' => 'Email konfirmasi harus sama dengan email yang dimasukkan.'
                ]
            ],
            'alamat' => [
                'rules' => 'required',
        ...
        if (!is_dir(FCPATH . 'doc/masuk/')) {
            mkdir(FCPATH . 'doc/masuk/', 0777, true);
        }

        // Pindahkan file ke folder 'doc/masuk/' dengan nama baru
        $fileLampiran->move(FCPATH . 'doc/masuk/', $namaLampiran);
    ...
    ";
        ...
        return redirect()->to('/beranda/permohonan')->with('success', 'Data berhasil terkirim');
    }
