  ...
  <section class="section">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <!-- Table Start -->
        <table class="table table-hover table-responsive" id="table1" style="font-size: 14px; width: 100%;">
          ...
          <tbody>
            ...
            foreach ($layanan as $key => $row) : ?>
              <tr>
                ...
                <?php if ($row['status'] == 1) { ?>
                  <td style="color:green"><b><?= $row['nama_layanan'] ?></b></td>
                <?php } else { ?>
    ...
    <!-- Add Modal -->
    <?= $this->include('backend/data_layanan/form/add'); ?>

    <!-- Edit Modal -->
    <?= $this->include('backend/data_layanan/form/edit'); ?>

    <!-- Delete Modal -->
    <?= $this->include('backend/data_layanan/form/delete'); ?>
  </section>
</div>
